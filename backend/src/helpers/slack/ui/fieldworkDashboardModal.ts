 ...
 */
const buildFieldworkStudyPicker = (studyOptions: StudyOption[], activeStudyId: string | number | null) => {
...
export { buildFieldworkDashboard, buildFieldworkStudyPicker };
