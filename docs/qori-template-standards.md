...
| research_plan v5.0 | Operationalization cascade with constraints | Consumes 12 brief variables with commitment/constraint semantics. Plan must operate within brief's timeline, budget, scope constraints. Deliverables map to research objectives. |
