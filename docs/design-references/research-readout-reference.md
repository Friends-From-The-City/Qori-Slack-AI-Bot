<!--
This is a locked design reference for the research_readout template.
The visual design, structure, and traceability patterns shown here represent
the agreed-upon "ideal state" output for this template.

Status: Locked April 29, 2026
Next step: Translate this design into config/prompts/research_readout.yaml
-->
...
**Severity** — Critical &nbsp;|&nbsp; **Affected** — 2 of 3 participants &nbsp;|&nbsp; **Participants** — PT-001, PT-003
...
**Severity** — Critical &nbsp;|&nbsp; **Affected** — 1 of 3 participants &nbsp;|&nbsp; **Participants** — PT-003
...
**Severity** — High &nbsp;|&nbsp; **Affected** — 1 of 3 participants &nbsp;|&nbsp; **Participants** — PT-002
...
**Severity** — High &nbsp;|&nbsp; **Affected** — 1 of 3 participants &nbsp;|&nbsp; **Participants** — PT-001
...
**Severity** — Medium &nbsp;|&nbsp; **Affected** — 1 of 3 participants &nbsp;|&nbsp; **Participants** — PT-002
...
| Coded transcripts | `03-fieldwork/coded-transcript-analysis/` | Complete |
| Affinity map | `04-analysis/affinity-mapping/` | Complete |
| Journey map | `04-analysis/journey-mapping/` | Complete |
| Personas | `04-analysis/personas/` | Complete |
| Full study documentation | [Link to study folder]() | Available |
